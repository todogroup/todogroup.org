---
title: "Open Source Governance and Agentic Infrastructure: OSPOlogy + OSPO Summit China"
author: todogroup
date: 2026-09-19
---
...
Held during KubeCon + CloudNativeCon + OpenInfra Summit + PyTorch Conference China week, and alongside events including AGNTCon + MCPCon China, the summit
provided an especially timely setting for these conversations.
...
## A community conversation that keeps evolving: Shared learnings
...
A related discussion focused on the rapidly developing open infrastructure surrounding AI agents.

Models are only one component of an agentic system. Agent harnesses, tools, context, gateways, protocols, skills, and external data sources determine what an agent can actually do.
...
![OIN 2.0 session at OSPOlogy + OSPO Summit China](IMG_3172.JPG)
...
For more than two decades, Open Invention Network (OIN) has developed a community around patent non-aggression for open source. In 2026, OIN introduced OIN 2.0 to expand this model as open source moves into new technologies and industries.

Through OIN's cross-license, participating organizations commit to patent non-aggression around technologies included within its defined Linux System.
OIN 2.0 expands that protection as the open source technology landscape continues to evolve.


OSPOs can connect open source knowledge, product and engineering teams, and legal or IP functions, helping organizations understand how patent strategy
intersects with their participation in open source ecosystems. Recent developments in China illustrate this connection. ByteDance joined the OIN 2.0 community in August 2026, extending its participation in the patent non-aggression ecosystem as open source becomes increasingly important to global-scale technology infrastructure.

## Open standards and trusted software supply chains remain foundational

![Enterprise open source governance discussion in Shanghai](IMG_3170.JPG)
...
![Discussion during OSPOlogy + OSPO Summit China](IMG_3176.JPG)
...
## The conversations happen beyond the stage

![OSPO practitioners networking during the Shanghai event](IMG_3165.JPG)
...
![Community discussion during OSPOlogy + OSPO Summit China](IMG_3179.JPG)
...
The traditional OSPO remit around open source consumption, contribution, compliance, community participation, and strategy remains essentiat, but organizations are now building AI systems on top of a much broader collection of open technologies:**models, datasets, agent frameworks, protocols, gateways, developer tools,
specifications, standards, and cloud native infrastructure.**
