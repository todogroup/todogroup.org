...
- Are of the Linux Foundation members (including LF umbrella foundations such as the Cloud Native Computing Foundation), or qualify as LF Associate Members (governments, academic institutions, NGOs), and  
- Have, or are actively building, an open source / FOSS strategy and basic policies for using, contributing to, and releasing open source
