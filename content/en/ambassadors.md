...
Explore where our ambassadors are based, or filter the list below by country.

{{< ambassador-map >}}

{{< ambassador-list >}}

> To update this list, edit [`data/ambassadors.yml`](https://github.com/todogroup/todogroup.org/blob/main/data/ambassadors.yml). The map and table are both driven by that file.
...
* Make at least one contribution per month connected to a TODO initiative, resource, or community activity
* Advocate for OSPO best practices using and showcasing TODO Group resources
* Contribute to TODO resources, repositories, research, guides, and working-group deliverables
* Support, mentor, and onboard practitioners and newcomers
* Lead or support TODO Working Groups, OSPOlogy events, meetups, and other community initiatives
* Bring practitioner and community feedback back to TODO
* Represent TODO professionally, inclusively, and in line with the TODO Group mission

Examples of contributions include:

* Contributing to or reviewing the OSPO Book, TODO Guides, OSPO Glossary, Mind Map, Maturity Model, Awesome OSPO tool list, research studies, whitepapers, or other TODO resources
* Writing for the TODO blog or newsletter or mentioning TODO group in external blogs
* Contributing PRs, issues, reviews, translations, case studies, or other improvements to TODO repositories
* Co-chairing or moderating a TODO Working Group and helping move its deliverables forward
* Organizing or supporting OSPOlogy events / TODO community meetups in your region
* Creating educational content, talks, tutorials, or videos that demonstrate or reference TODO resources
* Answering community questions, mentoring practitioners, and helping newcomers contribute
...
* Be an active contributor to a TODO initiative, such as Awesome OSPO, OSPO Landscape, TODO website or blog, TODO resources, research, or Working Group deliverables (meeting notes, summary blogs, etc)
* Be a representative from a TODO General Member organization that has contributed an organizational use case or other practical input from the organization to TODO Group resources or initiatives.
* Be an OSPOlogy Program Committee member, organizer, or roundtable mentor or speaker
* Be an active co-chair or facilitator in a TODO Working Group, with 1+ year of experience moderating, mentoring, or creating content related to the WG scope
...
* Recognition for their contributions to TODO and the OSPO community
...
* Opportunities to contribute expertise to TODO-branded research, studies, whitepapers, events, and community initiatives
* Potential amplification of Ambassador contributions through TODO community channels
...
If eligible, [submit an Ambassador application](https://github.com/todogroup/governance/issues/new/choose) with evidence of your involvement and contributions to the TODO community.
