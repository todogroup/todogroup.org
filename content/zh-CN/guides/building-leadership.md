...
开源项目是由多样和地理分布广泛的社区开发的，这些社区有着自己的规则、惯例、工具和流程。简而言之，每个社区都有其独特的文化，需要时间来建立在开源中高效工作所需的信任、协作方式和文化理解。

本指南阐述了组织如何在参过且商业上也有依赖的开源项目中建立领导力和影响力，了解项目内的领导文化和角色，决策的制定方式，组织如何建立领导力，以及在开源社区中成为一名优秀领导者的技巧。

## 为何在开源项目中建立领导力

尽管开源文化是协作式的，向上游贡献也只是塑造开源项目发展的第一步。如果项目对公司自身产品至关重要，那么积极参与指导或影响项目方向也很重要。

尽管开源项目已多次证明合作的价值，甚至包括竞争对手，但无法参与项目方向决策很快会变成竞争劣势。这就是为什么在开源项目中建立和维护领导力对企业的战略和目标至关重要。然而，这并不像敲桌子或挥舞金钱一样容易。

## 开源中的领导力文化

一般，公司首先认为在开源社区中的领导工作方式与公司中的领导工作方式相同。事实并非如此。

"公司往往会经历这样的阶段，认为 '哦，我们很大，为什么不能敲敲桌子，让社区按我们的意愿行事呢？'" 在Autodesk的Open@ADSK倡议主管Guy Martin解释道。"他们很快意识到这种策略行不通。他们逐渐明白，获得领导地位的唯一方法是在社区内赢得角色。而唯一的实现就是赢得信誉并作出贡献。”
