...
市场推广涉及将大量行为捆绑在一个功能中：销售。即使您销售的产品恰好是免费的，情况也是如此。
...
除了在内部寻找推广资源之外，项目还可以向外寻求上级组织和开源基金会的帮助。例如，如果您的项目是云工具项目，那么您可能会从[CNCF](https://cncf.io) 或 [OpenJS](https://openjsf.org) 基金会得到帮助。另一个例子是 ASF，它通过[新闻稿](https://www.apache.org/press/) 来帮助项目，这是一种很有用的推广形式。
...
要确定联合推广机会，您可以首先与参与项目的大公司的员工详细讨论想法，因为他们既能够看到项目的利益和公司的利益，又能看到它们的契合点。
...
推广能力对于成功至关重要。您要确保该项目正在解决一个关键问题并且清晰地把它阐述明白。您还需要找出该项目与其他解决相同问题的项目不同处。另外，您还需要知道项目的最终目标。
...
俗话说，你无法管理无法衡量的东西。但如果你无法验证目标，你也不能宣称成功。通过设定具体目标，您就确定了衡量标准。以此为基础，您需要选择有助于您衡量和跟踪推广计划绩效的指标和工具。

您可以在 Github 和各种项目中找到指标和推广仪表板，您可以将其用作示例或直接使用，例如 [CHAOSS 项目]( https://chaoss.community/) 中的工具、分析和仪表板。

此类工具有很多，仅此一项就可能令人不知所措。选择那些基本的度量标准来回答如下问题，“我们的推广工作在项目影响力上表现如何？

您甚至可以使用现有项目仪表板上已有的一些指标来管理项目。如果您的项目没有这样的仪表板，或者您想创建一个专门用于跟踪项目推广影响的仪表板，您可能选用类似 [OSS-仪表板](https://github.com/amzn/oss-dashboard) 或其他商业工具来操作。
...
要培养一批通过贴纸、口碑或志愿服务自豪地宣传您的品牌的追随者，您可以在做出任何决定之前让社区参与品牌和消息传递过程。在启动推广计划之前获得认可对于短期和长期的成功都至关重要。
...
<<<<<<< HEAD
在社区外进行推广以吸引新人来帮助您完成项目使命也同样重要。进行此类推广的主要形式是各种活动。出席、赞助和演讲都是有效且常见的推广策略。在活动中进行演示是完善你的信息的一种方式，并且可以根据受众量身定制。如果预算允许，您还可以选择举办自己的活动，这提供了将开发者和用户聚集在一处的绝佳机会。市面上有很多活动主办公司，您也可以与像 Linux 基金会 [Linux基金会](https://events.linuxfoundation.org) 这样的组织合作举办活动。
=======
...
>>>>>>> 25fdc36 (content/zh-CN/guides/marketing-open-source-projects.md)

使用社交媒体进行推广，无论是在活动中还是作为更广泛的沟通工具，都会非常有效。无论您选择哪种社交媒体，请记住消息可以有多种用途。例如，通过发布一则招聘启事，并同时列出公司与之合作并为之贡献的开源项目，公司既可以吸引求职者，同时也可以提升项目品牌。在其他地方发布的招聘信息同样可以起到额外的推广作用。

博客文章、教程、演示、白皮书和视频等内容在吸引和留住会员方面也发挥着关键作用。此内容还可以用于共享项目信息以及如何在代码以外进行贡献。您拥有的内容越多，看到并做出回应的人就越多。只需确保内容是最新的，并且删除过时的材料。

直接推广（例如电子邮件和在线广告）在外部推广中也同样重要，因为它们可以使您主动接触到可能从未听说过您的项目的人士。这些方法可以用于提高知名度，或者推广特定的行动号召。请确保所有消息传递都符合社区准则和推广计划的标准。

另一个免费推广项目的想法是 SEO（搜索引擎优化），您可以优化项目页面本身，或写文章来进行优化，以吸引访问者访问您的项目。这在文章[如何通过 SEO 推广您的开源项目](https://itnext.io/seo-for-open-source-projects-1a6b17ffeb8b)中有详细描述。
